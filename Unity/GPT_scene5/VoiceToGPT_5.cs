...
//wifi
public class VoiceToGPT_5 : MonoBehaviour
{
    public Transform player;
    public OVRRayHelper rayHelper;
    public LayerMask objectLayer;
    public OpenAITTS_5 tts;
    public subtitles_5 subtitles;
    public local_llm_5 llm;
    ...
    void Start()
    {
        ...
        subtitles = FindObjectOfType<subtitles_5>();
        tts = FindObjectOfType<OpenAITTS_5>();
        llm = FindObjectOfType<local_llm_5>();
    ...
    {
        string APIPath = Path.Combine(Application.dataPath, "Unity", "GPT_scene5", "api_key.json");
