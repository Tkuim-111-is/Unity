...
//wifi
public class VoiceToGPT_3 : MonoBehaviour
{
    public Transform player;
    public OVRRayHelper rayHelper;
    public LayerMask objectLayer;
    public OpenAITTS_3 tts;
    public subtitles_3 subtitles;
    public local_llm_3 llm;
    ...
    void Start()
    {
        ...
        tts = FindObjectOfType<OpenAITTS_3>();
        llm = FindObjectOfType<local_llm_3>();
    ...
    {
        string APIPath = Path.Combine(Application.dataPath, "Unity", "GPT_scene3", "api_key.json");
